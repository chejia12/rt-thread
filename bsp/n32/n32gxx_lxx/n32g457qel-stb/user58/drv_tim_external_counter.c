...
2026-03-27
	在L406平台发现tim2和tim3的中断号配置成tim1的中断号了
2026-04-24
	添加注释
	新增了L406平台的TIM4,TIM5,TIM8,的配置信息
 *-
...
void n32_gpio_rcc_enable(GPIO_Module *gpio_grp)
{
    ...
    else if (GPIOE == gpio_grp)
    {
		...
		LOG_D("enable gpio rcc GPIOE");
    }
    else if (GPIOF == gpio_grp)
    {
        RCC_EnableAPB2PeriphClk(RCC_APB2_PERIPH_GPIOF, ENABLE);
		LOG_D("enable gpio rcc GPIOF");
    }
    else if (GPIOG == gpio_grp)
    {
        RCC_EnableAPB2PeriphClk(RCC_APB2_PERIPH_GPIOG, ENABLE);
		LOG_D("enable gpio rcc GPIOG");
    }
#endif
}
...
/******Select TIM2 CH1=PA6(0),PB4(2),PC6(3) ; CH2=PA7(0),PB5(2),PC7(3)******************************* */
#ifdef BSP_USING_TIM3_EXT_COUNTER 
        {
            .timer_periph = TIM3,
            .polarity = TIM_IC_POLARITY_RISING,
...
/******CH1=PA0(0,2),PA15(1,3) ; CH2=PA1(0,2),PB3(1,3)******************************* */
#ifdef BSP_USING_TIM4_EXT_COUNTER 
...
/******Select TIM8 CH1=PC6(0,1),PD14(3) ; CH2=PC7(0,1),PD15(3)****************************** */
#ifdef BSP_USING_TIM8_EXT_COUNTER 
...
/***************N32L406 TIM4 ****************************/
#ifdef BSP_USING_TIM4_EXT_COUNTER
        {
            ...
            .filter = 0x0,
            .irqn = TIM4_IRQn,
#ifdef TIM4_EXCK1_CH1_PB6
            .tim_channel = TIM_CH_1,
            .gpio_periph = GPIOB,
            .gpio_pin = GPIO_PIN_6,
            .gpio_af = GPIO_AF2_TIM4,
            .info = "TIM4 PB6",
#endif /*TIM4_EXCK1_CH1_PB6*/
#ifdef TIM4_EXCK1_CH2_PB7
            .tim_channel = TIM_CH_2,
            .gpio_periph = GPIOB,
            .gpio_pin = GPIO_PIN_7,
            .gpio_af = GPIO_AF2_TIM4,
            .info = "TIM4 PB7",
#endif /*TIM4_EXCK1_CH2_PB4*/
        },
#endif /*BSP_USING_TIM4_EXT_COUNTER*/
...
/***************N32L406 TIM5 ****************************/
#ifdef BSP_USING_TIM5_EXT_COUNTER
        {
            ...
            .filter = 0x0,
            .irqn = TIM5_IRQn,
#ifdef TIM5_EXCK1_CH1_PA0
            .tim_channel = TIM_CH_1,
            .gpio_periph = GPIOA,
            .gpio_pin = GPIO_PIN_0,
            .gpio_af = GPIO_AF1_TIM5,
            .info = "TIM5 PA0",
#endif /*TIM5_EXCK1_CH1_PB6*/
#ifdef TIM5_EXCK1_CH2_PA1
            .tim_channel = TIM_CH_2,
            .gpio_periph = GPIOA,
            .gpio_pin = GPIO_PIN_1,
            .gpio_af = GPIO_AF7_TIM5,
            .info = "TIM5 PA1",
#endif /*TIM5_EXCK1_CH2_PA1*/
        },
#endif /*BSP_USING_TIM5_EXT_COUNTER*/
...
/***************N32L406 TIM8 ****************************/
#ifdef BSP_USING_TIM8_EXT_COUNTER
        {
            ...
            .filter = 0x0,
            .irqn = TIM8_UP_IRQn,
#ifdef TIM8_EXCK1_CH1_PC6
            .tim_channel = TIM_CH_1,
            .gpio_periph = GPIOC,
            .gpio_pin = GPIO_PIN_6,
            .gpio_af = GPIO_AF6_TIM8,
            .info = "TIM8 PC6",
#endif /*TIM8_EXCK1_CH1_PC6*/
#ifdef TIM8_EXCK1_CH2_PC7
            .tim_channel = TIM_CH_2,
            .gpio_periph = GPIOC,
            .gpio_pin = GPIO_PIN_6,
            .gpio_af = GPIO_AF6_TIM8,
            .info = "TIM8 PC7",
#endif /*TIM8_EXCK1_CH2_PC7*/
        },
#endif /*BSP_USING_TIM8_EXT_COUNTER*/
...
static    rt_ssize_t n32_tim_ext_counter_read  (rt_device_t dev, rt_off_t pos, void *buffer, rt_size_t size)
{
    ...
    /* 读取当前计数值 */
    rt_uint32_t current_count = TIM_GetCnt(device->config->timer_periph);
